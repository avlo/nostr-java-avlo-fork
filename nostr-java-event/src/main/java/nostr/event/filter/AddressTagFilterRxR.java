...
//public class AddressTagFilterRxR<T extends AddressTagRxR> extends AbstractFilterableRxR<T> {
//  public final static String FILTER_KEY = "#a";
//
//  public AddressTagFilterRxR(T addressableTag) {
...
//    return (genericEvent) ->
//        FilterableRxR.getTypeSpecificTags(AddressTagRxR.class, genericEvent).stream()
//            .anyMatch(addressTag ->
...
//  }
//
//  public static Function<JsonNode, FilterableRxR> fxn = node ->
//      new AddressTagFilterRxR<>(createAddressTag(node));
//
